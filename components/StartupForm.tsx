...
const StartupForm = () => {
    ...
    const [state,formAction,isPending] = useActionState(handleFormSubmit,{
        initialState:{error:'',status:'INITIAL'}});
  ...
  return (
    <form action={formAction} className='startup-form'>
        ...
        <div>
            ...
            {errors?.desc && <p className="startup-form_error">{errors?.desc}</p>}
        </div>
        ...
        <div data-color-mode="light">
            ...
            <MDEditor id="pitch" preview="edit" height={300} style={{borderRadius:20,overflow:'hidden'}} value={pitch} onChange={(value)=>setPitch(value as string)} textareaProps={{
